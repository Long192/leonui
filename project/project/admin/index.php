...
<body style="background-image: url(content/img/background.jpg); background-position: center; background-repeat: no-repeat; background-size: cover; height: 100%; width: 100%;">
	<?php 
